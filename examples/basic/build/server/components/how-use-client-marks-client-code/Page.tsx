...
function FancyTextBoundary(props) {
    ...
    return (<>
      ...
      <template type="forket/start" id="f_40" data-c="FancyText"></template>
      <FancyText {...props} children={children}/>
      <template type="forket/end" id="f_40" data-c="FancyText"></template>
    </>);
}
function InspirationGeneratorBoundary(props) {
    ...
    return (<>
      ...
      <template type="forket/start" id="f_41" data-c="InspirationGenerator"></template>
      <InspirationGenerator {...props} children={children}/>
      <template type="forket/end" id="f_41" data-c="InspirationGenerator"></template>
    </>);
}
