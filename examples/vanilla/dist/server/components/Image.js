...
function Image({ id, className, isPlaceholder, children }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "grid p1 bordered-dark " + (className || ""), style: { gridTemplateColumns: "1fr 4fr" } }, /* @__PURE__ */ React.createElement("div", { className: "lh0" }, /* @__PURE__ */ React.createElement("a", { href: `/image/${id}`, target: "_blank" }, /* @__PURE__ */ React.createElement("img", { src: `/image/${id}`, alt: "Uploaded content", className: "image-fit" }))), /* @__PURE__ */ React.createElement("div", { className: "px1" }, children));
}
