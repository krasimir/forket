import { getTotalNumberOfQuotes as f_11 } from "./server-actions/quotes.ts";
import { getQuote as f_10 } from "./server-actions/quotes.ts";
const actions = {
    $FSA_f_9_getQuote: f_10,
    $FSA_f_8_getTotalNumberOfQuotes: f_11
};
